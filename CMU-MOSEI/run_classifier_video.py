...
def main(i):
    ...
    ## ADDITIONAL ##
    multimodal_data = pickle.load(open('data/audio/MOSEI_cmu_audio_CLS.pickle','rb'))
    train_audio, valid_audio, test_audio = multimodal_data['train']['audio'], multimodal_data['valid']['audio'], multimodal_data['test']['audio']
    train_video,valid_video,test_video = multimodal_data['train']['vision'], multimodal_data['valid']['vision'], multimodal_data['test']['vision']
